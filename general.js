	...
	**/
	...
	scripts:{//Скрипты
		add:function(n){//Добавить и загрузить
			...
			FlyVK.other.addScript("//raw.githubusercontent.com/xor2003/flyvk/master/libs/"+name+".js");
			n.value = "";
		},
	...
	onready:function(id){
		...
		FlyVK.other.addScript("//raw.githubusercontent.com/xor2003/flyvk/master/lang/"+FlyVK.lang_id+".js?r="+FlyVK.r);
	},
	timer:{
